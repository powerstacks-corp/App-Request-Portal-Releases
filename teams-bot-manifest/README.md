...
This directory contains the Microsoft Teams app manifest for the App Store for Intune bot.
...
| `your-portal-url.azurewebsites.net` | Your App Store for Intune URL (appears in `websiteUrl`, `privacyUrl`, `termsOfUseUrl`, and `validDomains`) |
...
4. Search for "App Store for Intune" and add it
5. Click **Save**
